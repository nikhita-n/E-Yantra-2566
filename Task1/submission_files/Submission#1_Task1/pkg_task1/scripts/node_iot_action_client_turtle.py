...
from pkg_task1.msg import msgTurtleFeedback     # Message Class that is used for F
...
#Callback function to get message from the mqtt client 
#The turtle will move only when it gets message Start or start
...
class SimpleActionClientTurtle:
    ...
    def done_callback(self, status, result):
        ...
        #Print the data on our spreadsheet
        ...
        response = requests.get(URL2, params=parameters)
        print(response.content)
        #Print data on the sheet url provided by e-Yantra:
        #parameters = {"id":"task1", "team_id":"VB_2566", "unique_id":"rSnNRsNn", "turtle_x":result.final_x, "turtle_y":result.final_y, "turtle_theta":result.final_theta} 
        URL_eYantra = "https://script.google.com/macros/s/AKfycbw850dk4moVgebU2GGe0PUQUvvg8jTpSjBQCawJt3_13vgujLk/exec"
        response = requests.get(URL_eYantra, params=parameters)
        print(response.content)
